...
function openEditUserModal(userId) {
    ...
    var eyeOpen = document.getElementById('edit-eye-icon-open');
    var eyeClosed = document.getElementById('edit-eye-icon-closed');
...
// Password Visibility Controller for Edit Modal
function toggleEditPasswordVisibility() {
    var input = document.getElementById('edit-password');
    var eyeOpen = document.getElementById('edit-eye-icon-open');
    var eyeClosed = document.getElementById('edit-eye-icon-closed');
    if (!input) return;
